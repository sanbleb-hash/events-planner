		...
		>
			...
			<div className=' flex items-center justify-center lg:items-start lg:justify-start flex-col flex-1 gap-5 z-20'>
				...
				<p className=' p-5 lg:p-0  lg:pt-5 text-gray-300 '>
					Looking for things to do in Western Cape? Whether you&apos;re a local,
					new in town or just cruising through we&aposve got loads of great tips
					and events. You can explore by location, what &apos;s popular, our top
